...
## Aktuální verze: v44 (2. 8. 2026), SW cache `progres-v44.0`, commit `cb758bd`

Self-contained `index.html` (968 987 B / 962 934 znaků, MD5 `f60d4282e1d2b5dd71f98340b505ca81`). Báze pro příští diff z Designu: `cd_upload44.html` (958 861 B, MD5 `85e27a84dff9863992538742ff522acb`, bez shimu).
