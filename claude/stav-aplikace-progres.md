...
## Aktuální verze: v52 (3. 8. 2026), SW cache `progres-v52.0`, commit doplní push (commity vznikly v Cowork session, push z Karlova terminálu)

Self-contained `index.html` (982 806 B / 976 641 znaků, MD5 `c178af2a456bc5cdc6bf40d3d0778ae0`). Báze pro příští diff z Designu: `cd_upload45.html` (962 393 B, MD5 `240276aed8e8be7141936910eb243fac`, bez shimu) — v46–v52 vznikly mimo Design.
