...
## Aktuální verze: v48 (2. 8. 2026), SW cache `progres-v48.0`, commit doplní příští session (git běžel u Karla v terminálu, viz pozn. u v48)

Self-contained `index.html` (976 229 B / 970 121 znaků, MD5 `3900d27f455e119fc2b02e62926751c4`). Báze pro příští diff z Designu: `cd_upload45.html` (962 393 B, MD5 `240276aed8e8be7141936910eb243fac`, bez shimu) — v46–v48 vznikly mimo Design.
