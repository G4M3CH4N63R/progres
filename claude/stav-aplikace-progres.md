...
## Aktuální verze: v43 (2. 8. 2026), SW cache `progres-v43.0`, commit `b6f9f4d`

Self-contained `index.html` (975 630 B / 969 583 znaků, MD5 `04dfccfd3e51a246c1405c87c6fdfbe0`). Báze pro příští diff z Designu: `cd_upload43.html` (965 448 B, MD5 `e16116771ab86be7af25b1b26a321da3`, bez shimu).
...
**Trénink:** **od v42 jde zpětně upravit zaznamenaný trénink** — ikona posuvníků v historii načte záznam do formuláře včetně sérií a vah, uložení přepíše původní. Dál: typ Fitko / Kardio / Jiné; týdenní přehled + Statistiky (síla, objem cviku, rekordy, objem partií, **heatmapa konzistence za 20 týdnů**). Fitko = partie + cviky se sériemi (modré zvýraznění nevyplněného; steppery s držením, krok u kg 0,5; pauza; koš s potvrzením); výběr cviku přes picker; databáze + vlastní; **šablony s detailem, načtením a přejmenováním**; kroky; AI plán; historie **s možností pojmenovat trénink**.  Kardio = aktivita + kruhový číselník + slider metriky.
